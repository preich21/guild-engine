const en = {
  ...
  quizzes: {
    heading: "Quizzes",
    empty: "No quizzes are available yet.",
    pointsLabel: "Points",
    validTimeframe: "This quiz can be completed between {validFrom} to {validTo}.",
    doQuizNowButton: "Do quiz now",
    createYourOwnTooltip: "Want to create your own quiz?",
    createYourOwnHeading: "Create your own quiz",
    typeDefinitionLabel: "Quiz data type definition",
    noEndDate: "no end date",
    createSteps: {
      title: "Decide on a title for your quiz.",
      data: "Create your quiz data in json format, so it matches the following type definition. (Your AIssitent may be able to help you, simply give them the definition and tell them to produce valid JSON.)",
      contactAdmin: "Contact your admin with your title and quiz data so they can create it for you.",
    },
    workInProgress: "work in progress",
    timeframeLabel: "Timeframe",
    answerLabel: "Answer",
    backButton: "Back",
    backToQuizSelectionButton: "Back to Quiz Selection",
    continueButton: "Continue",
    correctAnswerLabel: "Correct answer",
    submitButton: "Submit",
    submitError: "Could not submit this quiz. Please try again.",
    submittedWithPoints:
      "Submitted successfully! Your points have been granted. You answered {correct} out of {total} questions correctly.",
    submittedWithoutPoints:
      "Submitted successfully! No additional points have been granted. You answered {correct} out of {total} questions correctly.",
    invalidData: "This quiz is currently unavailable because its data is invalid.",
    alreadySubmitted:
      "You already submitted this quiz on {timestamp}. Doing it a second time will not grant you additional points.",
  },
  topbar: {
    brand: "Guild Engine",
    ...
    quizManagementLink: "Quiz Management",
  ...
  admin: {
    ...
    quizManagement: {
      ...
      createTooltip: "Create new quiz",
      noEntries: "No quizzes yet. Use the button above to create a new one.",
      newCardTitle: "Create new quiz",
      editCardTitle: "Edit quiz",
      titleLabel: "Title",
      idLabel: "ID",
      ...
      modifiedByFallback: "unknown user",
      datePickerPlaceholder: "Select date",
      noValidToLabel: "No end date",
      cancelButton: "Cancel",
      saveButton: "Save",
      saveSuccess: "Quiz saved.",
      saveError: "Could not save quiz. Please check your inputs.",
      updateSuccess: "Quiz updated.",
      updateError: "Could not update quiz. Please check your inputs.",
      deleteButtonAriaLabel: "Delete quiz",
      editButtonAriaLabel: "Edit quiz",
      deletePopoverTitle: "Delete quiz",
      deletePopoverDescription: "Are you sure you want to delete quiz {title}?",
      deleteDisabledTooltip:
        "This quiz already has submissions and can therefore no longer be deleted.",
      deleteConfirmButton: "Yes",
      deleteCancelButton: "No",
      deleteError: "Could not delete quiz. Please try again.",
      showDataButton: "Show quiz data",
      hideDataButton: "Hide quiz data",
      dataValidation: {
        invalidJson: "The quiz data is not valid JSON: {message}",
        rootArray: "The quiz data must be a JSON array.",
        nonEmptyArray: "The quiz data must contain at least one question.",
        questionObject: "{path} must be a question object.",
        questionText: "{path} must be a non-empty string.",
        questionType: '{path} must be either "enum" or "number".',
        answerPossibilitiesArray: "{path} must be a non-empty array.",
        answerPossibilityText: "{path} must be a string.",
        correctAnswerIndex: "{path} must be an integer.",
        correctAnswerIndexRange: "{path} must point to an existing answer possibility.",
        correctAnswerNumber: "{path} must be a number.",
      },
    },
    achievements: {
      ...
      featureQuizzes: "Quiz Participation ([value] or more)",
      valueLabel: "Value",
