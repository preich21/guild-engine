const de = {
  ...
  quizzes: {
    ...
    doQuizNowButton: "Quiz jetzt machen",
    createYourOwnTooltip: "Möchtest du dein eigenes Quiz erstellen?",
    createYourOwnHeading: "Eigenes Quiz erstellen",
    typeDefinitionLabel: "Typdefinition der Quizdaten",
    noEndDate: "kein Enddatum",
    createSteps: {
      title: "Entscheide dich für einen Titel für dein Quiz.",
      data: "Erstelle deine Quizdaten im JSON-Format, so, dass sie der folgenden Typdefinition entsprechen. (Dein AIssistent kann dir sicher behilflich sein. Gib ihm einfach die Typdefinition und fordere valides JSON.)",
      contactAdmin:
        "Kontaktiere deine Admins mit deinem Titel und den Quizdaten, damit sie es für dich erstellen können.",
    },
    workInProgress: "work in progress",
    timeframeLabel: "Zeitraum",
    answerLabel: "Antwort",
    backButton: "Zurück",
    backToQuizSelectionButton: "Zurück zur Quiz-Auswahl",
    continueButton: "Weiter",
    correctAnswerLabel: "Richtige Antwort",
    submitButton: "Absenden",
    submitError: "Dieses Quiz konnte nicht abgesendet werden. Bitte versuche es erneut.",
    submittedWithPoints:
      "Erfolgreich abgesendet! Deine Punkte wurden gutgeschrieben. Du hast {correct} von {total} Fragen richtig beantwortet.",
    submittedWithoutPoints:
      "Erfolgreich abgesendet! Es wurden keine zusätzlichen Punkte gutgeschrieben. Du hast {correct} von {total} Fragen richtig beantwortet.",
    invalidData: "Dieses Quiz ist derzeit nicht verfügbar, weil seine Daten ungültig sind.",
    alreadySubmitted:
      "Du hast dieses Quiz bereits am {timestamp} abgesendet. Ein zweites Mal bringt dir keine zusätzlichen Punkte.",
  },
  topbar: {
    brand: "Guild Engine",
    ...
    quizManagementLink: "Quiz-Verwaltung",
  ...
  admin: {
    ...
    quizManagement: {
      ...
      createTooltip: "Neues Quiz erstellen",
      noEntries: "Noch keine Quizze vorhanden. Nutze den Button oben, um ein neues zu erstellen.",
      newCardTitle: "Neues Quiz erstellen",
      editCardTitle: "Quiz bearbeiten",
      titleLabel: "Titel",
      idLabel: "ID",
      ...
      modifiedByFallback: "unbekannter Benutzer",
      datePickerPlaceholder: "Datum auswählen",
      noValidToLabel: "Kein Enddatum",
      cancelButton: "Abbrechen",
      saveButton: "Speichern",
      saveSuccess: "Quiz gespeichert.",
      saveError: "Quiz konnte nicht gespeichert werden. Bitte prüfe deine Eingaben.",
      updateSuccess: "Quiz aktualisiert.",
      updateError: "Quiz konnte nicht aktualisiert werden. Bitte prüfe deine Eingaben.",
      deleteButtonAriaLabel: "Quiz löschen",
      editButtonAriaLabel: "Quiz bearbeiten",
      deletePopoverTitle: "Quiz löschen",
      deletePopoverDescription: "Möchtest du das Quiz {title} wirklich löschen?",
      deleteDisabledTooltip:
        "Für dieses Quiz gibt es bereits Einreichungen, deshalb kann es nicht mehr gelöscht werden.",
      deleteConfirmButton: "Ja",
      deleteCancelButton: "Nein",
      deleteError: "Quiz konnte nicht gelöscht werden. Bitte versuche es erneut.",
      showDataButton: "Quiz-Daten anzeigen",
      hideDataButton: "Quiz-Daten ausblenden",
      dataValidation: {
        invalidJson: "Die Quiz-Daten sind kein gültiges JSON: {message}",
        rootArray: "Die Quiz-Daten müssen ein JSON-Array sein.",
        nonEmptyArray: "Die Quiz-Daten müssen mindestens eine Frage enthalten.",
        questionObject: "{path} muss ein Frage-Objekt sein.",
        questionText: "{path} muss ein nicht leerer Text sein.",
        questionType: '{path} muss entweder "enum" oder "number" sein.',
        answerPossibilitiesArray: "{path} muss ein nicht leeres Array sein.",
        answerPossibilityText: "{path} muss ein Text sein.",
        correctAnswerIndex: "{path} muss eine Ganzzahl sein.",
        correctAnswerIndexRange: "{path} muss auf eine vorhandene Antwortmöglichkeit zeigen.",
        correctAnswerNumber: "{path} muss eine Zahl sein.",
      },
    },
    achievements: {
      heading: "Erfolge",
      ...
      basedOnFeatureLabel: "Basiert auf Feature",
      basedOnPositionLabel: "Basiert auf Position",
      featureLabel: "Feature",
      featurePoints: "Punkte (Summe größer als [Wert])",
      featureIndividualLeaderboardPosition: "Individuelle Ranglistenposition ([Wert] oder höher)",
      featureTeamLeaderboardPosition: "Team-Ranglistenposition ([Wert] oder höher)",
      ...
      metricLabel: "Metrik",
      validValuesLabel: "Gültige Werte",
      validValuesAtLeastLabel: "Gültige Werte (dieser oder höher)",
      validValuesPlaceholder: "Gültige Werte auswählen",
      typeLabel: "Typ",
      typePlaceholder: "Typ auswählen",
      typeCount: "Anzahl Meetings",
      typeStreak: "Meeting-Serie",
      timeFrameLabel: "Zeitraum",
      ...
      basedOnFeatureSummary: "Basiert auf Feature",
