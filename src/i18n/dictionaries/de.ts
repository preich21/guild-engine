const de = {
  ...
  admin: {
    ...
    achievements: {
      ...
      typeCount: "Anzahl",
      typeStreak: "Serie",
      timeFrameLabel: "Zeitraum (leer lassen für gesamte Zeit)",
      timeFramePlaceholder: "Dauer wie 90d oder 1y eingeben",
      timeFrameParsedHint: "Zielt auf einen Zeitraum der letzten {duration} ab.",
      timeFrameInvalid: "Gib eine gültige Dauer wie 90d, 2w, 3mo oder 1y ein.",
      ...
      durationYearSingular: "Jahr",
      durationYearPlural: "Jahre",
      durationMonthSingular: "Monat",
      durationMonthPlural: "Monate",
      durationWeekSingular: "Woche",
      durationWeekPlural: "Wochen",
      durationDaySingular: "Tag",
      durationDayPlural: "Tage",
      durationHourSingular: "Stunde",
      durationHourPlural: "Stunden",
      durationAnd: "und",
      cancelButton: "Abbrechen",
      saveButton: "Speichern",
